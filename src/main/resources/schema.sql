...
DROP TABLE IF EXISTS mpa_names;

CREATE TABLE IF NOT EXISTS mpa_names
(
    id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name varchar(5) NOT NULL,
    CONSTRAINT uc_name_mpa UNIQUE (name)
);
...
(
    ...
    CONSTRAINT uq_name_genre_film UNIQUE (name)
);
...
(
    ...
    CONSTRAINT fk_films_mpa_film_id FOREIGN KEY(film_id) REFERENCES films (id) ,
    CONSTRAINT fk_film_mpa_mpa_id FOREIGN KEY(mpa_id) REFERENCES mpa_names (id)
);
...
(
    ...
    CONSTRAINT fk_film_genres_mpa_id FOREIGN KEY(genre_id) REFERENCES genre_names (id)
);
